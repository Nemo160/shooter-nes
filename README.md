...
**Note to self on component access**<br>
...
this**, the instance referenced this way can be old, and in the worst case it risks a
recursive loop if you're not careful. Do better research on these types of game architecture before blindly implementing the first good thing you found.
...
would've cost me another full day by hand. I handed that part to an AI coding agent (as it was suggested by a more senior developer) and it was
done in minutes, the thinking was mine, the dirty work wasn't. Nevertheless, this gave me a headache.
